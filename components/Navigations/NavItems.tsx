...
export const DashboardIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
...
export const TicketsIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const InventoryIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M20 7H4a1 1 0 00-1 1v11a1 1 0 001 1h16a1 1 0 001-1V8a1 1 0 00-1-1z" stroke={color} strokeWidth="2" />
...
export const ConsumablesIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    {/* Printer body */}
    <Rect x="4" y="8" width="16" height="9" rx="1.5" stroke={color} strokeWidth="2" />
    {/* Paper tray top */}
    <Path d="M7 8V5a1 1 0 011-1h8a1 1 0 011 1v3" stroke={color} strokeWidth="2" strokeLinecap="round" />
    {/* Paper output */}
    <Path d="M7 17v2a1 1 0 001 1h8a1 1 0 001-1v-2" stroke={color} strokeWidth="2" strokeLinecap="round" />
    {/* Ink dot */}
    <Circle cx="17" cy="12.5" r="1.2" fill={color} />
  </Svg>
);

export const AnalyticsIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <ChartColumn color={color} size={size} />
);

export const ReportsIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" stroke={color} strokeWidth="2" strokeLinecap="round" />
    <Path d="M14 2v6h6M16 13H8M16 17H8M10 9H8" stroke={color} strokeWidth="2" strokeLinecap="round" />
  </Svg>
);

export const UsersIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="9" cy="7" r="4" stroke={color} strokeWidth="2" />
    <Path d="M3 21v-2a4 4 0 014-4h4a4 4 0 014 4v2" stroke={color} strokeWidth="2" strokeLinecap="round" />
    <Path d="M16 3.13a4 4 0 010 7.75M21 21v-2a4 4 0 00-3-3.87" stroke={color} strokeWidth="2" strokeLinecap="round" />
  </Svg>
);

export const SettingsIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
