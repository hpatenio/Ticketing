...
// NavItems.tsx or wherever your nav items are defined
export const adminNavItems = [
  { key: "dashboard", label: "Dashboard", icon: "home" },
  { key: "inventory", label: "IT Inventory", icon: "laptop" },
  { key: "consumables", label: "IT Consumables", icon: "printer" },
  { key: "tickets", label: "Concern Tickets", icon: "ticket" },
];
